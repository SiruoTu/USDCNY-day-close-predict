...
```{r}
data1 <- data
data1[nrow(data1),2] <- data1[nrow(data1),2] + 0.0045
data1[nrow(data1)-1,2] <- data1[nrow(data1)-1,2] - 0.04
data1[nrow(data1)-2,2] <- data1[nrow(data1)-2,2] - 0.05
#data1[nrow(data1)-3,2] <- data1[nrow(data1)-3,2] - 0.02
#data1[nrow(data1)-4,2] <- data1[nrow(data1)-4,2] - 0.1
#data1[nrow(data1)-5,2] <- data1[nrow(data1)-5,2]-0.1
#data1[nrow(data1)-6,2] <- data1[nrow(data1)-6,2]+0.1
